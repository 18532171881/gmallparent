...
import com.zjh.gmall.admin.ums.vo.UmsAdminLoginParam;
import com.zjh.gmall.admin.ums.vo.UmsAdminParam;
import com.zjh.gmall.admin.utils.JwtTokenUtil;
...
//        }
    ...
    *
    * 1如果前端发过来的是json字符串，要封装对象
    * （@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result）
    * 2如果前端发过来的是k=v&k=v字符串，要封装对象
    * （UmsAdminLoginParam umsAdminLoginParam, BindingResult result）
    *
    * */
    ...
    public Object getAdminInfo(HttpServletRequest request) {
        ...
        //查询用户头像
        //getOne是mybatis-plus生成的，而且带了泛型的
        //dubbo没办法直接调用mp中带反省的service
        //实战经验：
            //mp自动生成咏鹅能有兼容问题，最好不要远程调用
